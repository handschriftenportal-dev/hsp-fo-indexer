...
/**
 * GenericRepositoryService providing CRU operations for manipulating {@link SchemaVersion}
 */
public class SchemaVersionRepositoryImpl implements de.staatsbibliothek.berlin.hsp.fo.indexer.persistence.SchemaVersionRepository {
  ...
  private final Repository<SchemaVersion> repository;

  public SchemaVersionRepositoryImpl(Repository<SchemaVersion> repository) {
