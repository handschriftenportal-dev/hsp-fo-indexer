...
public class MappingTestModel {
  ...
  @XMLSource(selectors = {@Selector(xPath = "//tei:msDesc/tei:head/tei:index[@indexName='norm']/tei:term[@type='foo']"), @Selector(xPath = "//tei:msDesc/tei:head/tei:index[@indexName='norm']/tei:term[@type='bar']")}, priority = 1)
  @XMLSource(selectors = @Selector(xPath = "//tei:msDesc/tei:physDesc/tei:objectDesc/tei:supportDesc/tei:extent/tei:dimensions[@type='leaf' and @unit='cm']/tei:height"), priority = 2)
  private String testAttr_multiNode_singleSelector_firstEmpty;

  @XMLSource(selectors = @Selector(xPath = "//tei:msDesc/tei:head/tei:index[@indexName='norm']/tei:term[@type='height']"), priority = 1)
  @XMLSource(selectors = @Selector(xPath = "//tei:msDesc/tei:physDesc/tei:objectDesc/tei:supportDesc/tei:extent/tei:dimensions[@type='leaf' and @unit='cm']/tei:height"), priority = 2)
  private String testAttr_multiNode_singleSelector;

  @XMLSource(selectors = @Selector(xPath = "//tei:msDesc/tei:head/tei:index[@indexName='norm']/tei:term[@type='height']"), priority = 2)
  @XMLSource(selectors = @Selector(xPath = "//tei:msDesc/tei:physDesc/tei:objectDesc/tei:supportDesc/tei:extent/tei:dimensions[@type='leaf' and @unit='cm']/tei:height"), priority = 1)
  private String testAttr_multiNode_singleSelector_prioritized;

  @XMLSource(selectors = @Selector(xPath = "//tei:msDesc/tei:head/tei:index[@indexName='norm']/tei:term[@type='height'] | //tei:msDesc/tei:physDesc/tei:objectDesc/tei:supportDesc/tei:extent/tei:dimensions[@type='leaf' and @unit='cm']/tei:height", isMultiValue = true), priority = 1)
  @XMLSource(selectors = @Selector(xPath = "//tei:msDesc/tei:physDesc/tei:objectDesc/tei:supportDesc/tei:extent/tei:dimensions[@type='leaf' and @unit='cm']/tei:width"), priority = 2)
  ...
  private String corporatePostProcessorWithNormdatum;

  @XMLSource(selectors = @Selector(xPath = "//tei:msDesc/tei:msIdentifier/tei:repository", attribute = "key", processingUnits = @ProcessingUnit(processorClass = CorporatePostProcessor.class, mapper = ResultMapper.PREFERRED_NAME)))
  private String corporatePreferredPostProcessorWithNormdatum;
  ...
  private String corporatePreferredPostProcessorWithoutNormdatumWithDefault;

  @XMLSource(selectors = @Selector(xPath = "//tei:msDesc/tei:msIdentifier/tei:settlement", attribute = "key", processingUnits = @ProcessingUnit(processorClass = PlacePostProcessor.class, mapper = ResultMapper.PREFERRED_NAME)))
  private String placePreferredPostProcessorWithNormDatum;
  ...
  private String placePreferredPostProcessorWithoutNormDatum;
  ...
  private String placePostProcessorWithNormDatum;
