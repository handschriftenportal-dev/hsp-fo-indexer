...
import de.staatsbibliothek.berlin.hsp.fo.indexer.mapping.postprocessing.attributes.*;
import lombok.Data;
...
public class HspDescription extends HspBaseDocument {
  ...
  @XMLSource(selectors = @Selector(xPath = "/tei:TEI/tei:text/tei:body/tei:msDesc/tei:head/tei:index[@indexName='norm_textLang']/tei:term[@type='textLang-ID']", attribute = "key", isMultiValue = true))
  @Field("language-display")
  private String[] languageDisplay;

  @Field("language-facet")
  @XMLSource(selectors = @Selector(xPath = "/tei:TEI/tei:text/tei:body/tei:msDesc/tei:head/tei:index[@indexName='norm_textLang']/tei:term[@type='textLang-ID']", attribute = "key", isMultiValue = true, processingUnits = @ProcessingUnit(processorClass = LanguagePostProcessor.class)))
