...
public class HSPException extends Exception {
  ...
  protected final boolean isSerious;

  public HSPException(final String message, final boolean isCausedByDependence, final boolean isSerious) {
    super(message);
    this.isCausedByDependence = isCausedByDependence;
    this.isSerious = isSerious;
  }

  public HSPException(final String message, final Exception ex, final boolean isCausedByDependence, final boolean isSerious) {
    super(message, ex);
    this.isCausedByDependence = isCausedByDependence;
    this.isSerious = isSerious;
  }
   ...
   *
   * @return true if exception is caused by a dependent, false otherwise
   */
   ...
   *
   * @return true if exception is serious, false otherwise
   */
