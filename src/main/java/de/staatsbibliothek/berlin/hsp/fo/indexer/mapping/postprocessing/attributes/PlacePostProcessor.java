 ...
 */
public class PlacePostProcessor extends PostProcessor implements IAttributePostProcessor {
   ...
   * @param values       the attributes mapped value (represents the ids)
  ...
  public List<String> process(final XMLSource source, final List<String> values, final ResultMapper resultMapper, final IContentResolver... resolver) throws ContentResolverException {
    return process(source, values, resultMapper, GNDEntityType.PLACE, resolver);
  }
}