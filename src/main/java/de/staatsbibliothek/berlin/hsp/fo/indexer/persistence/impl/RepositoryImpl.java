...
public class RepositoryImpl<T extends HspBase> implements Repository<T> {
  ...
  public RepositoryImpl(@Autowired
                       final PersistenceService<T> persistenceService, HspObjectType type) {
  ...
  public Optional<T> findById(final String id) throws PersistenceServiceException {
    return findByIdAndType(id);
  }

  @Override
  public Collection<T> findByGroupId(final String groupId) throws PersistenceServiceException {
    return persistenceService.find(Constants.FIELD_NAME_GROUP_ID + ":" + groupId + AND + typeFilter);
  }
  ...
  @Override
  public boolean deleteByGroupId(String groupId) throws PersistenceServiceException {
    return this.persistenceService.remove(Constants.FIELD_NAME_GROUP_ID + ":" + groupId + AND + typeFilter);
  }
  ...
  private Optional<T> findByIdAndType(final String id) throws PersistenceServiceException {
