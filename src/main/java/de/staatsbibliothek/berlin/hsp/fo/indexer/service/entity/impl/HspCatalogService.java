...
public class HspCatalogService implements RepositoryService<HspCatalog> {
  private final GenericRepositoryServiceImpl<HspCatalog> hspCatalogRepository;

  @Autowired
  public HspCatalogService(GenericRepositoryServiceImpl<HspCatalog> hspCatalogRepository) {
