...
import de.staatsbibliothek.berlin.hsp.fo.indexer.service.schema.SchemaService;
import de.staatsbibliothek.berlin.hsp.fo.indexer.service.schema.SchemaVersionService;
...
public class HspFoIndexerCommandLineRunner implements CommandLineRunner {
  private final RepositoryService<HspObjectGroup> groupService;

  private final NachweisHttpAdapter nachweisHttpAdapter;
