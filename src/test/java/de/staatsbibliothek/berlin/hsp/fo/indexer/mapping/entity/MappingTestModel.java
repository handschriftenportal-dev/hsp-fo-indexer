...
public class MappingTestModel {
  ...
  @XMLSource(selectors = @Selector(xPath = "//tei:titleStmt/tei:respStmt/tei:persName[2]", attribute = "key", defaultValue = "text()", additionalValue = "key", processingUnits = @ProcessingUnit(processorClass = PersonPostProcessor.class)))
