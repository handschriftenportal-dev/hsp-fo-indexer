...
public class TestPostProcessor implements IAttributePostProcessor {
   ...
   * @param normdatumURI the URI of the normdatum if not already provided by the {@code value}, can be {@code null}
   * @param resolver
   * @return the processed values
   */
  public List<String> processWithOtherName(XMLSource source, List<String> values, String normdatumURI, IContentResolver resolver) {
