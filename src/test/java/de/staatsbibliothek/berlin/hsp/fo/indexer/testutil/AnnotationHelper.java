...
public class AnnotationHelper {
  ...
  public static XMLSource getXMLSource(final String xPath, final boolean multiValue, final int prio) {
    return getXMLSource(new Selector[]{getSelector(xPath, multiValue)}, prio, true);
  }

  public static XMLSource getXMLSource(final String xPath, final boolean multiValue, final int prio, final boolean distinct) {
    return getXMLSource(new Selector[]{getSelector(xPath, multiValue)}, prio, distinct);
  }

  public static XMLSource getXMLSource(final Selector[] selectors, final int prio, final boolean distinct) {
