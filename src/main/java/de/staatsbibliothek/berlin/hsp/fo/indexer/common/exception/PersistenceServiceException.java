...
public class PersistenceServiceException extends HSPException {
  ...
  public PersistenceServiceException(final String message, final boolean isCausedByDependant, final boolean isSerious) {
    super(message, isCausedByDependant, isSerious);
  }
  ...
  public PersistenceServiceException(final String message, final Exception cause, final boolean isCausedByDependant, final boolean isSerious) {
    super(message, cause, isCausedByDependant, isSerious);
  }
}
