...
@TestConfiguration
@ContextConfiguration(classes = {HspObjectGroupServiceImpl.class, NachweisHttpAdapter.class, SchemaVersionServiceImpl.class})
@SuppressWarnings("SpringJavaInjectionPointsAutowiringInspection")
public class ApplicationTestConfiguration {

  public static String CONF_PATH = "solr";
  ...
  @Bean
  NachweisHttpAdapter nachweisHttpAdapter() {
    return new NachweisHttpAdapter();
  }
