...
import de.staatsbibliothek.berlin.hsp.fo.indexer.mapping.postprocessing.attributes.LanguagePostProcessor;
...
public class HspObject extends HspBaseDocument {
  ...
  @XMLSource(selectors = @Selector(xPath = "/tei:TEI/tei:teiHeader/tei:fileDesc/tei:sourceDesc/tei:msDesc/tei:msIdentifier/tei:altIdentifier[@type='former']/tei:idno", isMultiValue = true))
  ...
  @XMLSource(selectors = @Selector(xPath = "/tei:TEI/tei:teiHeader/tei:fileDesc/tei:sourceDesc/tei:msDesc/tei:head/tei:index[@indexName='norm_textLang']/tei:term[@type='textLang-ID']", attribute = "key", isMultiValue = true))
  @Field("language-display")
  private String[] languageDisplay;

  @Field("language-facet")
  @XMLSource(selectors = @Selector(xPath = "/tei:TEI/tei:teiHeader/tei:fileDesc/tei:sourceDesc/tei:msDesc/tei:head/tei:index[@indexName='norm_textLang']/tei:term[@type='textLang-ID']", attribute = "key", isMultiValue = true, processingUnits = @ProcessingUnit(processorClass = LanguagePostProcessor.class)))
